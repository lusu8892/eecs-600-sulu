...
BaxterTrajActionClient::BaxterTrajActionClient(ros::NodeHandle* nodehandle)
        :myInterestingMoves(nodehandle), action_client_("trajActionServer", true)
{
    g_count_ = 0;
    // attempt to connect to the server:
    ROS_INFO("waiting for server: ");
...
BaxterTrajActionClient::~BaxterTrajActionClient()
{
...
int main(int argc, char** argv) {
    ...
    baxterTrajActionClient.callInterestingMove(&MyInterestingMoves::rightArmZeroConfig);
    baxterTrajActionClient.callInterestingMove(&MyInterestingMoves::rightArmSaluteMove);
    baxterTrajActionClient.callInterestingMove(&MyInterestingMoves::rightArmZigzagMove);
    baxterTrajActionClient.callInterestingMove(&MyInterestingMoves::rightArmComeOnMove);
