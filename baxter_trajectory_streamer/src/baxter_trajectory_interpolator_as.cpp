...
private:
    ...
    // it will communicate using messages defined in baxter_trajectory_streamer/action/traj.action
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "baxter_trajectory_interpolator_action_server"); // name this node     
    ros::NodeHandle nh;
