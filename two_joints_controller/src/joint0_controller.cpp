...
int main(int argc, char **argv) {
    ros::init(argc, argv, "joint0_controller");
    ros::NodeHandle nh;
    ...
    ros::Publisher trq_publisher = nh.advertise<std_msgs::Float64>("jnt0_trq", 1); 
    ros::Publisher vel_publisher = nh.advertise<std_msgs::Float64>("jnt0_vel", 1);     
    ros::Publisher pos_publisher = nh.advertise<std_msgs::Float64>("jnt0_pos", 1);  
    ros::Publisher joint_state_publisher = nh.advertise<sensor_msgs::JointState>("joint0_states", 1); 

    ros::Subscriber pos_cmd_subscriber = nh.subscribe("joint0_pos_cmd",1,posCmdCB); 
    ...
    effort_cmd_srv_msg.request.joint_name = "joint0";
    effort_cmd_srv_msg.request.effort = 0.0;
    effort_cmd_srv_msg.request.duration= duration;

    get_joint_state_srv_msg.request.joint_name = "joint0";
    //double q1_des = 1.0;
    double q1_err;
    double Kp = 10.0;
    double Kv = 3;
    ...
    // called joint0, and initial position and vel values of 0
