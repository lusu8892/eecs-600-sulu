...
{
public:
    MinimalCommanderClass(ros::NodeHandle* nodehandle, double rate); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
...
MinimalCommanderClass::MinimalCommanderClass(ros::NodeHandle* nodehandle, double rate):nh_(*nodehandle), naptime_(rate)
{ // constructor
